...
export const COUNTRIES_LIST = [
  ...
  { name: "Curaçao", flag: "🇨🇼", code: "CW", dialCode: "+599" },
  ...
  { name: "Sint Maarten", flag: "🇸🇽", code: "SX", dialCode: "+1721" },
...
] as const satisfies readonly CountryProps[];

/** The union of every real ISO 3166-1 alpha-2 code in the list. */
export type CountryCode = (typeof COUNTRIES_LIST)[number]["code"];
